...
M = [
 ...
 ('screens-ai-on', 'app/dev/ds/dashboard-screens.tsx', '            <RfqComposer model={composer} aiEnabled={false} />', '            <RfqComposer model={composer} aiEnabled={true} />'),
 ...
 '      { label: "Awaiting reply", count: count((r) => r.status.label.startsWith("Quoted")) },'),
 ...
 ('c10-topbar-date-as-corpus-fact',
 'lib/dashboard/gallery-data.ts',
 ...
 '        <div id={mainId} className={cn("mx-auto flex w-full max-w-[calc(75rem+3rem)] flex-col gap-4 p-6", contentClassName)}>\n          {children}\n        </div>'),
