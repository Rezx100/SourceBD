-- Buyer Smart Match Discover wrapper.
-- Keeps Find Matches aligned with the proven Discover search brain while
-- avoiding the slower shared-candidate Discover wrapper from 0068.
...
comment on function public.buyer_smart_match(jsonb) is
  'Buyer Smart Match wrapper around discover_suppliers. Shares Discover taxonomy and compound-intent search while returning match reasons and paginated totals.';
