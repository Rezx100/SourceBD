> ARCHIVE — verbatim copy of `context/current-state.md` as of 18 Sep 2026, moved out of the boot set. Read a named section only when a specific historical decision, migration, or regression requires it. Not maintained.
