...
function PublicResultCard({ row }: { row: DiscoverRow }) {
    ...
    <Card className="transition hover:shadow-l2">
      <CardContent className="py-4">
        <Link
          ...
          className="flex items-start gap-4 min-w-0 rounded-card focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-indigo"
        >
