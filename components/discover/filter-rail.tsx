...
export function FilterRail({
  ...
  return (
    <section aria-label="Filter suppliers" className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-[0_1px_2px_rgba(15,15,20,0.03)] sm:p-5">
      <form method="get" action={basePath} className="space-y-3">
        ...
        {hideSearchRow ? (
          ...
          <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
            <div className="flex-1">
              <label htmlFor={qId} className="mb-1.5 block text-xs font-semibold text-ink-tertiary">
                Search
              </label>
              <input
                id={qId}
            ...
            <div className="flex items-end">
              <button type="submit" className="btn-proto primary h-[42px] px-5">
                Apply
              </button>
            </div>
          </div>
        ...
        <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)_minmax(0,180px)]">
          <Field label="City">
            <input
              type="text"
              name="city"
          ...
          <Field label="Certification">
            <fieldset className="flex min-h-[42px] flex-wrap items-center gap-1.5 rounded-input border border-neutral-200 bg-neutral-50 px-2 py-1.5">
              <legend className="sr-only">Certification</legend>
              {CERT_KINDS.map((opt) => {
                const checked = certKinds.includes(opt.value);
                return (
                  <label
                    key={opt.value}
                    className={cn(
                  ...
                  >
                    <input
                      ...
                      className="h-3.5 w-3.5 rounded border-hairline accent-brand-forest"
                    />
                    <span>{opt.label}</span>
                  </label>
                );
        ...
        <details className="group overflow-hidden rounded-xl border border-neutral-200 bg-white transition-colors">
          <summary
          ...
          >
            <span className="flex min-w-0 items-center gap-2">
              <span className="min-w-0">
                <span className="block">More filters</span>
                <span className="block truncate text-[12px] font-medium text-ink-tertiary">
                  District, product, entity, registry, brand, factory type
                </span>
              </span>
              {advancedCount > 0 ? (
            ...
            <span className="text-[12px] font-semibold text-ink-tertiary">Open</span>
          </summary>
...
function CheckboxGroup({
  ...
  return (
    <fieldset className={cn("rounded-lg border border-neutral-200 bg-neutral-50 p-2.5", className)}>
            ...
            <label
              ...
              className={cn(
                ...
                checked
                  ...
                  : "border-transparent bg-transparent text-ink-secondary hover:border-neutral-200 hover:bg-white hover:text-ink-primary",
              )}
            >
              <input
                type="checkbox"
